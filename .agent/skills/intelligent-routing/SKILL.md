...
| **UI/UX Design**    | "design", "dashboard", "landing", "page", "theme", "redesign" | `frontend-specialist` + `/ui-ux-pro-max` workflow | ✅ YES       |
...
| **UI/UX Design**| design, dashboard, landing, page, theme, palette, typography | `frontend-specialist` + run `/ui-ux-pro-max` workflow |
